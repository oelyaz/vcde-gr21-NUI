...
- <i class="ph ph-person-arms-spread" aria-hidden="true"></i> **Pose**: Ganzkörper-Steuerung. Erst kurz neutral und ruhig stehen
  ...
  *Tipp:* Stell dich ca. 2–3 m zurück, sodass Schultern und Hüfte im
...
Der Pinch ist der einzige kontinuierliche Kanal: kurzer Pinch = Klick,
...
„Midas-Touch“. Maus und Tastatur funktionieren weiterhin jederzeit, auch zum
Spielen selbst (Pflicht-Fallback aus dem vendored Runner).

Die folgende Tabelle fasst den Mapping-Layer zusammen, also unsere Übersetzung
Quelle → Intent → Aktion. Dieselbe Quelle kann je nach Modus anders belegt sein; das ist der Sinn der Entkopplung.
...
<p class="nui-dock-pointer">
  Die Steuerung sitzt im schwebenden NUI-Dock unten rechts.
  Es bleibt auch beim Scrollen sichtbar. Dort die Kamera starten,
  den Modus wählen und Hand-Nav ein-/ausschalten (Taste <kbd>N</kbd>).
...
BSD-Lizenz; vendored mit kleinen Einbettungs-Guards für die lokale Demo.
Die Gesten-/Pose-Steuerung darüber ist Eigenleistung. Tracking läuft über
MediaPipe Tasks-Vision (Google, Apache-2.0), zur
